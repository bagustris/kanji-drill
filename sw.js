const CACHE_VERSION = 'kanji-drill-v22';
...
const CORE_ASSETS = [
  ...
  'data/sentences3.json',
  'data/sentences4.json',
  'data/sentences5.json',
  'data/sentences6.json',
  'data/sentences7.json',
  'data/sentences8.json',
  'data/sentences9.json',
];
